...
public class Floor extends PlainObject {
    ...
    /**
     * constructor for complex object that imported from anywhere and have acceleration
     * @param assetManager assetmanager for pathing
     * @param name name that gonna inputed to node
     * @param path the path in your directionary
     * @param vx acceleration x
    ...
    /**
     * method used for adding some texture ( like images or something )
     * and material (effect )
     * this method directly set the spatial with the material and texture
